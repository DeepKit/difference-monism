...
class CookieJar:
    ...
    def to_cookie_header(self, url: str) -> str:
        """生成Cookie请求头"""
...
if __name__ == "__main__":
    ...
    # 为URL生成Cookie头
    header = jar.to_cookie_header('https://example.com/api')
    print(f"Cookie: {header}")
    
    # 获取所有匹配的Cookie
    cookies = jar.get_cookies_for_url('https://example.com/api/users')
    for c in cookies:
        print(c.to_set_cookie_header())