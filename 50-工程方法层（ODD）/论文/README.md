...
>
> **当前状态**：本目录是 ODD 论文路线图与论文系列入口。对外稳定主对象目前是 `Paper I` 与白皮书，其余论文条目多数仍属于投稿规划、提纲或后续扩展方向。

---

## 发布边界

- `适用范围`：论文路线规划、Paper I 入口、后续论文序列组织
- `不是什么`：所有列出的 Paper 都已完成或已可公开投稿的声明
- `外发纪律`：当前公开时优先外发 `论文-学术版.md`、`Paper_01_ODD_Core_English_2026-01-16.md`、`白皮书.md`；其余系列默认按规划中的后续工作处理
...
- **Paper I**：继续承担概念与方法论基础稿角色，主打范式、定义、边界、责任与系列框架，不冒充已经完成大规模实证的系统论文。
- **Paper E1**：承接 `5000+` 样本、ablation、adaptive adversarial、P95/P99、成本与运维等软件工程实证任务。
- **Paper E2**：承接跨领域迁移、垂直场景深挖、对比基线与领域适配边界，不把这些要求挤回 `Paper I`。
