...
```mermaid
graph TD
    A[Undifferentiated State<br/>The One Base] -->|Perturbation Occurs| B[The Five<br/>Structural Space]
    B -->|Temporal Evolution| C[The Six<br/>Dynamic Rhythm]
    C -->|Analysis & Operation| D[The Seven<br/>Action Path]
    D -->|Establish New Rules| E[Oriented Dimension<br/>Norms & Bottom Lines]
    E -->|Return to Inclusion| A
    
    R[Human Adjudication Layer<br/>Risk Control] -.->|Guard Boundary| A
    R -.->|Guard Boundary| B
    R -.->|Guard Boundary| C
    R -.->|Guard Boundary| D
    R -.->|Guard Boundary| E
