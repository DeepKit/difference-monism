...
flowchart TD
    ...
    T["Structural Features of Cognitive Errors: Three Constraints Mechanism"]:::title

    A1["Energy Conservation Constraint<br/>Energy & Dissipation<br/>Cognition tends to effort-saving & simplifying"]:::axiom
    A2["Utility Constraint<br/>Survival Benefit/Fitness<br/>Cognition biases towards actionable consequences"]:::axiom
    A3["Imperfection Constraint<br/>World-Model Gap<br/>Cognition incomplete & needs calibration"]:::axiom

    R["Structural Feature of Cognitive Errors<br/>By-product under Meta-Constraints<br/>Not accidental anomaly"]:::result
...
flowchart TD
    ...
    T["Defect Nature Decision Tree<br/>Productive vs Destructive Defect"]:::title

    Start["Detect Cognitive Bias"]:::question

    Q1["Generates new possibilities? - Creativity/Metaphor/Association"]:::question
    Q2["Occurs when info is insufficient? - Exploration/Gap Filling"]:::question
    Q3["Harms Plurality of others? - Dignity/Freedom/Ethics"]:::question

    P1["Productive Defect"]:::productive
    D1["Destructive Defect"]:::destructive
    D2["Destructive Defect"]:::destructive
    D3["Destructive Defect"]:::destructive
    ...
    %% Strategy Annotation
    P1 -->|Strategy: Protect<br/>Utilize bias for creation| S1["Keep in thinking layer<br/>As innovation hotbed"]
    D1 -->|Strategy: Counteract<br/>Structural suppression| S2["Solidify in engineering layer<br/>Checklist/Double-check"]
    D2 -->|Strategy: Counteract<br/>Correction mechanism| S3["Introduce verification<br/>Evidentiary Cognition"]
    D3 -->|Strategy: Counteract<br/>Ethical Circuit-Breaker| S4["Taboo Guardian<br/>Stop Immediately"]
...
flowchart TD
    ...
    T["Knowing = Attribute Recognition + Trend Prediction + Intervention Capacity<br/>ASTO Operational Definition"]:::title

    subgraph Input ["Input: Field Signal"]
        I1["Attribute-Set Attributes<br/>Color/Weight/Emotion/Relation"]:::input
        I2["Field Context<br/>Time/Space/Other"]:::input
    end

    subgraph Processing ["Processing: Cognitive Ability"]
        P1["Attribute Recognition<br/>Distinguish Key/Noise"]:::process
        P2["Trend Prediction<br/>Forecast Change Direction"]:::process
        P3["Intervention Capacity<br/>Design Effective Action"]:::process
    end

    subgraph Output ["Output: Effective Action"]
        O1["Perturbation Injection<br/>Change Attribute-Set Transition Path"]:::output
    ...
    %% Missing Warning
    M1["Recognition Only<br/>No Intervention = Spectator"]:::output
    M2["Prediction Only<br/>No Recognition = Fantasy"]:::output
    M3["Intervention Only<br/>No Prediction = Blind Action"]:::output
...
flowchart TD
    ...
    T["Knowledge Three-State Flow: Wet → Dry → Living<br/>Corresponding Five States: In-itself/Consensus → Encoded/Materialized → Oriented"]:::title

    subgraph Wet ["Wet Knowledge 80-100% Water"]
        W1["In-itself State<br/>Body Intuition"]:::wet
        W2["Consensus State<br/>Team Tacit"]:::wet
    end

    subgraph Dry ["Dry Knowledge 0-20% Water"]
        D1["Encoded State<br/>Doc/Rules"]:::dry
        D2["Materialized State<br/>Tool/System"]:::dry
    end

    subgraph Living ["Living Knowledge Rehydrating"]
        L["Oriented State<br/>Contextual App"]:::living
    end
    ...
    %% Rehydration Process
    D1 & D2 -->|Rehydrate<br/>Dry+Context+Subject| L
    L -->|Sediment| D1
...
flowchart TD
    ...
    T["Perturbation Epistemology: Sense → Exert Loop<br/>Dynamics of Unity of Knowing and Doing"]:::title

    subgraph Field ["Field"]
        F1["Interaction/Coupling<br/>Grade: Intensity/Direction/Scale/Duration"]:::field
    end

    subgraph Knowing ["Knowing (Sense Perturbation)"]
        P1["Threshold Window<br/>Perceptible over threshold"]:::perceive
        P2["Attribute Recognition<br/>Capture difference info"]:::perceive
        P3["Trend Prediction<br/>Forecast change"]:::process
    end

    subgraph Doing ["Doing (Exert Perturbation)"]
        A1["Intervention Decision<br/>Design minimal action"]:::act
        A2["Exert Perturbation<br/>Inject energy into field"]:::act
    end

    F1 -->|Cross Threshold| P1
    P1 --> P2 --> P3
    P3 -->|Leap| A1
    A1 --> A2
    A2 -->|Change Field| F1
    ...
    %% Loop
    C1["Loop Closed<br/>Unity"]:::process
...
```mermaid
flowchart TD
    subgraph E ["🟠 Unity of Knowing and Doing: Leap from Knowing to Doing"]
        direction TB
        
        Thinking["Thinking Layer<br/>Know but Not Act<br/>'I know I should exercise'"]
        Acting["Acting Layer<br/>Act but Not Reach<br/>'Ran once, legs hurt'"]
        Engineering["Engineering Layer<br/>Unity<br/>'I run daily after work'"]
        Reverence["Reverence Layer<br/>Know and Respect Unknown<br/>'I accept body limits'"]
        
        Thinking -->|Courage Leap| Acting
        Acting -->|Refine Solidify| Engineering
        Engineering -->|Release Bandwidth| Thinking
        
        Engineering -->|Boundary Aware| Reverence
        Reverence -.->|Constraint| Thinking
        Reverence -.->|Ethical| Acting
        Reverence -.->|Red Line| Engineering
    end
...
```mermaid
graph TD
    A[Thinking Layer<br/>Know Not Act] -->|Courage| B[Acting Layer<br/>Act Not Reach]
    B -->|Verify| C[Engineering Layer<br/>Unity]
    C -->|Release Bandwidth| A
    
    A --> D[Imagination<br/>Innovation]
    B --> E[Trial Bed<br/>Experience]
    C --> F[Norm Solidification<br/>Accumulation]
    
    C --> G[Respect Unknown<br/>Boundary]
    G -.->|Constraint| A
    G -.->|Ethical| B
    G -.->|Red Line| C
