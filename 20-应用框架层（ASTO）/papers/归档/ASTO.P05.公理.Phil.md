...
> - 已阅读 [ASTO.P04 宣言](../ASTO.P04.宣言.Phil.v12.5.md) 以理解本体论背景
...
> **⚠️ 读者请注意**：
> 从本章节（ASTO.P05）开始，我们将脱离 [ASTO.P04 宣言](../ASTO.P04.宣言.Phil.v12.5.md) 中的叙事性、隐喻性语言模式（Storytelling Mode），切换至**严格定义模式 (Strict Definition Mode)**。
>
...
> 
> 本节定义的 $(P, C)$ 二元组，是对 [P04 §0.2A](../ASTO.P04.宣言.Phil.v12.5.md) 中**属集**概念的**工程操作化投影**（Engineering Projection），而非本体论替代。
...
> **回应 [ASTO.P04 宣言](../ASTO.P04.宣言.Phil.v12.5.md) 的伦理决断**：
...
> **目标**：守护人类家园，并在更长尺度上构建更好的文明。详见 [ASTO.P04.宣言 §0 文明元定义](../ASTO.P04.宣言.Phil.v12.5.md#asto-civilization-meta-definition)。
...
**与进化论的关系**：进化中的「变异」就是本律式/涌现式动变性，「自然选择」就是环境张力对属集的筛选。详见 [ASTO.E01 实践指南](./ASTO.E01.实践指南.Eng.md)
...
│   ├── [P05. 公理](./ASTO.P05.公理.Phil.md) (系统热力学与结构存在论) ← 本文档
