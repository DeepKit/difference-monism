...
### 10.2 禁元的三重来源与判准
1.  **定向维禁元**：规则定义的（如：API速率限制）。需通过**复数性测试（启发式）**（见 ASTO.P06.价值与边界.Phil.md）。  
...
### 10.4 工程提示（迁移至 E05）
工程部分已迁移至 **ASTO.E05.工程实践手册.Eng.v1.0.md**，其中包含：对抗测试、赛马机制、封板/解封、产出物擢升、以及具体模板与指标。
...
| :--- | :--- | :--- | :--- |
| **功能树 (Functional Tree)** | **属集模式可视化**：将庞大的系统拆解为可视化的树状结构，明确依赖关系与责任边界。 | **属集模式即骨架** | ASTO.E01.实践指南.Eng.v2.0.md |
| **Bug意向图 (Intention Map)** | **意图对齐**：Bug 往往是意图与现实的偏差。通过绘图，找回最初的设计意图与假设。 | **解析 (Resolve)** | ASTO.E05.工程实践手册.Eng.v1.0.md |
| **变异测试 (Mutation Testing)** | **信任转移**：不信代码，信测试。故意修改代码看测试能否发现，从而验证测试的有效性。 | **反脆弱** | ASTO.E05.工程实践手册.Eng.v1.0.md |
| **对抗测试 (Adversarial Testing)** | **压力注入**：不仅验证"能工作"，还要验证"能抵抗攻击"。引入恶意输入。 | **扰动普遍性** | ASTO.E05.工程实践手册.Eng.v1.0.md |
| **赛马机制 (Horse Racing)** | **进化选择**：对于不确定路径（定向维），不事先指定唯一解，而是并行跑多个方案，优胜劣汰。 | **场域选择** | ASTO.E05.工程实践手册.Eng.v1.0.md |
| **最佳实践 (Best Practices)** | **经验凝结**：将成功的扰动模式固化为可复用的模板（归元）。 | **归元 (Return)** | ASTO.E05.工程实践手册.Eng.v1.0.md |
...
> 进一步工程化细则，请移步 **ASTO.E05.工程实践手册.Eng.v1.0.md**。
...
### B.2 如果你是解决问题的工程师...
*   去读 **ASTO.P05.公理.Phil.md**：理解系统的物理法则。  
*   去读 **ASTO.H01.重构.Hum.v10.0.md**：学习架构师的视角。  
*   **最重要的**，请看下面的工具箱索引 ↓  

### B.3 工程工具箱索引
| 核心问题 | 工具/机制 | 对应文档 |
| :--- | :--- | :--- |
| **如何确保代码合规？** | **红绿灯协议** (Traffic Light Protocol) | ASTO.E02.自动化.Eng.v8.0.md |
| **如何测试系统极限？** | **对抗测试** (Adversarial Testing) | ASTO.E05.工程实践手册.Eng.v1.0.md |
| **多方案怎么选？** | **赛马机制** (Horse Race) | ASTO.E05.工程实践手册.Eng.v1.0.md |
| **如何发布不回滚？** | **封板/解封** (Seal/Unseal) | ASTO.E05.工程实践手册.Eng.v1.0.md |
| **Web3代码有Bug哋办？** | **意图宪法** (Intent Constitution) | ASTO.E03.Web3.Eng.v8.0.md |
| **AI胡说八道哋办？** | **RLEN** (规范强化学习) | ASTO.E04.AI对齐.Eng.v8.0.md |
...
│   ├── ASTO.P05.公理.Phil.md (系统热力学与属集变迁存在论)
...
│   ├── ASTO.E01.实践指南.Eng.v2.0.md (生活|人文|工程三轨读本)
│   ├── ASTO.E02.自动化.Eng.v8.0.md (可执行规范与零摩擦治理)
│   ├── ASTO.E03.Web3.Eng.v8.0.md (意图宪法与链上三权分立)
│   ├── ASTO.E04.AI对齐.Eng.v8.0.md (逆熵智能体与文明传承)
│   ├── ASTO.E05.工程实践手册.Eng.v1.0.md (对抗测试与赛马机制)
│   └── ASTO.E06.领域扩展.Eng.v1.0.md (多领域应用索引)
│
├── 🧩 H 系列：人文叙事 (Humanities)
│   ├── ASTO.H01.重构.Hum.v10.0.md (架构师的二十一种宇宙视角)
│   ├── ASTO.H02.导读：为什么读这本书.Hum.v1.0.md
│   ├── ASTO.H03.故事：小陈的那条路.Hum.v1.0.md
│   ├── ASTO.H04.认知冒险.Hum.v1.0.md
│   ├── ASTO.H05.奇幻漂流.Hum.v1.0.md
...
└── 🌍 Ext 系列：领域扩展 (Extensions)
    ├── ASTO.Ext.01.法律.Sci.P.v1.0.md
    ├── ASTO.Ext.02.科学.Sci.P.v1.0.md
    ├── ASTO.Ext.03.组织.Sci.P.v1.0.md
    ├── ASTO.Ext.04.教育.Sci.P.v1.0.md
    ├── ASTO.Ext.05.城市.Sci.P.v1.0.md
    ├── ASTO.Ext.06.医疗.Sci.P.v1.0.md
    ├── ASTO.Ext.07.宇宙.Sci.P.v1.0.md
    └── ASTO.Ext.08.留白.Sci.P.v8.0.md
```
...
| 06 | ASTO.P05.公理.Phil.md | 系统的热力学法则与属集变迁存在论 |
| 07 | ASTO.H01.重构.Hum.v10.0.md | 架构师的二十一种宇宙视角 |
| 08 | ASTO.E01.实践指南.Eng.v2.0.md | 介入复杂系统的工程指南 |
| 09 | ASTO.P07.自由论.Phil.md | 控制与混沌的平衡 |
| 10 | ASTO.P09.批判.Phil.md | 反极权宪章与系统免疫 |
| 11 | ASTO.E02.自动化.Eng.v8.0.md | 可执行规范与零摩擦治理 |
| 12 | ASTO.E03.Web3.Eng.v8.0.md | 意图宪法与链上三权分立 |
| 13 | ASTO.E04.AI对齐.Eng.v8.0.md | 逆熵智能体与文明的属集变迁传承 |
