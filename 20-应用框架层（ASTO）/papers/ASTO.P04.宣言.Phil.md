...
> - `0A`：传播性导读摘要壳；详细传播版外移至 [ASTO.P04A.生活化导读.传播稿](./ASTO.P04A.生活化导读.传播稿.md)
...
> 这一节改为“导读摘要壳”。详细传播版已外移至 [ASTO.P04A.生活化导读.传播稿](./ASTO.P04A.生活化导读.传播稿.md)。  
...
最短直觉：**存在先在 -> 观看切分 -> 扰动调速**。  
世界的改变常从一次负责任的扰动开始；详细叙事版见 [ASTO.P04A.生活化导读.传播稿](./ASTO.P04A.生活化导读.传播稿.md)。
...
若你需要传播版、课堂版或口语化讲解，转入 [ASTO.P04A.生活化导读.传播稿](./ASTO.P04A.生活化导读.传播稿.md)。  
...
### 10.4 工程提示（迁移至 E05）
工程部分已迁移至 **[ASTO.E05.工程实践手册](./工程版/ASTO.E05.工程实践手册.Eng.md)**，其中包含：对抗测试、赛马机制、封板/解封、产出物擢升、以及具体模板与指标。
...
| :--- | :--- | :--- | :--- |
| **功能树 (Functional Tree)** | **属集模式可视化**：将庞大的系统拆解为可视化的树状结构，明确依赖关系与责任边界。 | **属集模式即骨架** | [E01 实践指南](./工程版/ASTO.E01.实践指南.Eng.md) |
| **Bug意向图 (Intention Map)** | **意图对齐**：Bug 往往是意图与现实的偏差。通过绘图，找回最初的设计意图与假设。 | **解析 (Resolve)** | [E05 工程手册](./工程版/ASTO.E05.工程实践手册.Eng.md) |
| **变异测试 (Mutation Testing)** | **信任转移**：不信代码，信测试。故意修改代码看测试能否发现，从而验证测试的有效性。 | **反脆弱** | [E05 工程手册](./工程版/ASTO.E05.工程实践手册.Eng.md) |
| **对抗测试 (Adversarial Testing)** | **压力注入**：不仅验证"能工作"，还要验证"能抵抗攻击"。引入恶意输入。 | **扰动普遍性** | [E05 工程手册](./工程版/ASTO.E05.工程实践手册.Eng.md) |
| **赛马机制 (Horse Racing)** | **进化选择**：对于不确定路径（定向维），不事先指定唯一解，而是并行跑多个方案，优胜劣汰。 | **场域选择** | [E05 工程手册](./工程版/ASTO.E05.工程实践手册.Eng.md) |
| **最佳实践 (Best Practices)** | **经验凝结**：将成功的扰动模式固化为可复用的模板（归元）。 | **归元 (Return)** | [E05 工程手册](./工程版/ASTO.E05.工程实践手册.Eng.md) |
...
> 进一步工程化细则，请移步 **[ASTO.E05.工程实践手册](./工程版/ASTO.E05.工程实践手册.Eng.md)**。
...
*   去读 **[ASTO.H01. 重构](./人文版/ASTO.H01.重构.Hum.md)**：学习架构师的视角。  
*   **最重要的**，请看下面的工具箱索引 ↓  

### B.3 工程工具箱索引
| 核心问题 | 工具/机制 | 对应文档 |
| :--- | :--- | :--- |
| **如何确保代码合规？** | **红绿灯协议** (Traffic Light Protocol) | [ASTO.E02.自动化](./工程版/ASTO.E02.自动化.Eng.md) |
| **如何测试系统极限？** | **对抗测试** (Adversarial Testing) | [ASTO.E05.工程实践手册](./工程版/ASTO.E05.工程实践手册.Eng.md) |
| **多方案怎么选？** | **赛马机制** (Horse Race) | [ASTO.E05.工程实践手册](./工程版/ASTO.E05.工程实践手册.Eng.md) |
| **如何发布不回滚？** | **封板/解封** (Seal/Unseal) | [ASTO.E05.工程实践手册](./工程版/ASTO.E05.工程实践手册.Eng.md) |
| **Web3代码有Bug哋办？** | **意图宪法** (Intent Constitution) | [ASTO.E03.Web3](./工程版/ASTO.E03.Web3.Eng.md) |
| **AI胡说八道哋办？** | **RLEN** (规范强化学习) | [ASTO.E04.AI](./工程版/ASTO.E04.AI对齐.Eng.md) |
...
| 07 | [ASTO.H01. 重构](./人文版/ASTO.H01.重构.Hum.md) | 架构师的二十一种宇宙视角 |
| 08 | [ASTO.E01. 实践指南](./工程版/ASTO.E01.实践指南.Eng.md) | 介入复杂系统的工程指南 |
...
| 11 | [ASTO.E02. 自动化](./工程版/ASTO.E02.自动化.Eng.md) | 可执行规范与零摩擦治理 |
| 12 | [ASTO.E03. Web3](./工程版/ASTO.E03.Web3.Eng.md) | 意图宪法与链上三权分立 |
| 13 | [ASTO.E04. AI](./工程版/ASTO.E04.AI对齐.Eng.md) | 逆熵智能体与文明的属集变迁传承 |
