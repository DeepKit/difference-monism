...
> **目标**：在 AGI 到来之前守护人类家园，并在更长尺度上构建更好的文明。详见 [ASTO04.宣言 §0 文明元定义](./ASTO04.宣言.Proto.v11.0.md#asto-civilization-meta-definition)。
...
**与进化论的关系**：进化中的「变异」就是本律式/涌现式动变性，「自然选择」就是环境张力对属集的筛选。详见 [ASTO08 实践指南](./ASTO08.实践.Guide.v2.0.md)
