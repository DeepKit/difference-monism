...
> **完整版导航图**（含详细说明）见 ASTO17.附录.Glossary.md
...
*   **对应**：**"存在" (Being)**
*   **定义**：世界没有实体，只有属性的集合。
*   **公理依据**：ASTO04.公理.Proto.v8.0.md 公理 0-3（环境熵增、不完美、效用、节能）
...
> **注**：ODD (Output-Driven Development) 的核心论文见：Paper_01_ODD_Core_Chinese 2026-1-15.md
...
> **更详细的工程术语对照表**，请参见 ASTO17.附录.Glossary.md 中的 **ASTO-ODD 工程映射表**。
