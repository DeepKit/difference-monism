...
│   ├── [P99.1. 术语与层级总表](./ASTO.P99.1.术语与层级总表.md) (术语纪律与层级地位)
│   ├── [P99.2. 失败条件总表](./ASTO.P99.2.失败条件总表.md) (缩限 / 重写 / 放弃触发器)
│   ├── [P99.3. 标准案例编码模板](./ASTO.P99.3.标准案例编码模板.md) (1-5-6-7-1 编码)
│   └── [P99.4. 版本修订表](./ASTO.P99.4.版本修订表.md) (结构修订追踪)
│
