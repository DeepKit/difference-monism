...
The LLM landscape has exploded with options: GPT-4 Turbo ($0.01/1K input), Claude-3 Opus ($0.015/1K), GPT-3.5 Turbo ($0.0005/1K), DeepSeek ($0.0001/1K). Each model offers different trade-offs between capability, latency, and cost.
...
| Task | Optimal Model | Cost if GPT-4 | Cost if Optimal | Savings |
|------|---------------|---------------|-----------------|---------|
| "What is 2+2?" | DeepSeek | $0.01 | $0.0001 | 99% |
| "Translate 'hello' to French" | GPT-3.5 | $0.01 | $0.0005 | 95% |
| "Design a microservices architecture" | GPT-4 | $0.03 | $0.03 | 0% |
...
**Baselines**:
- **Always-Best**: Always use GPT-4 Turbo
- **Always-Cheap**: Always use DeepSeek
...
┌─────────────────────────────────────────────────────────┐
│ Simple tasks:   95% savings (DeepSeek vs GPT-4)        │
│ Medium tasks:   70% savings (GPT-3.5 vs GPT-4)         │
│ Complex tasks:  40% savings (Claude-3-Sonnet vs GPT-4) │
│ Expert tasks:    0% savings (GPT-4 required)           │
└─────────────────────────────────────────────────────────┘
```
...
**Routing decisions**:
```
"Add a comment to line 5"     → DeepSeek (complexity: 2)
"Explain this function"       → GPT-3.5 (complexity: 4)
"Refactor for performance"    → Claude-3.5-Sonnet (complexity: 7)
"Design microservices arch"   → GPT-4 (complexity: 9)
```
...
6. DeepSeek. (2024). DeepSeek-V2: A Strong, Economical, and Efficient Mixture-of-Experts Language Model. arXiv:2405.04434.
...
|-------|--------------|---------------|---------|---------|
| GPT-4 Turbo | 0.01 | 0.03 | 128K | ~2.5s |
| GPT-3.5 Turbo | 0.0005 | 0.0015 | 16K | ~0.8s |
| Claude-3 Opus | 0.015 | 0.075 | 200K | ~3.0s |
| Claude-3.5 Sonnet | 0.003 | 0.015 | 200K | ~1.5s |
| Claude-3 Haiku | 0.00025 | 0.00125 | 200K | ~0.5s |
| DeepSeek Chat | 0.0001 | 0.0002 | 64K | ~0.9s |
