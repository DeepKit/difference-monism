...
> 差异一元论（Difference Monism, DM）是一套以“差异、结构、边界、继承与层级涌现”为统一语法的哲学研究纲领。它试图在不预设实体本体论、心物二元论或终极目的论的前提下，重写存在、时间、规律、因果、意识、认识与规范之间的连续主链。版本 `v1.1` 为统一送审版：已形成可连续阅读的主干、明确的失败条件接口与最小外部征评包，但仍处于公开征评、批评吸收与长期验证阶段，不应被表述为最终成熟定稿。
...
> **DM 的公开版本为 `v1.1 统一送审版`。它已经适合公开征评、公开比较与预印本式发布，但仍保留开放边界，不应被包装为已经完成同行评审的终局理论。**
