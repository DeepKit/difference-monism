...
灯塔理论并非孤立存在，而是从一元论哲学主链中逐层推演的“系统诊断认识论”。

| 层级 | 名称 | 功能定义 | 位阶 |
|:---:|:---|:---|:---|
| **L1** | 一元论主链 (DM/ASTO/TAT) | 世界的本质、划界与解释逻辑 | 上位法源 |
| **L2** | 应用认识论层 | 哲学逻辑向领域逻辑的过渡 | 转换器 |
| **L3** | **市场诊断认识论（灯塔理论）** | 决策节点如何在高噪音中识别问题并校准行动 | **原理层（本体）** |
| **L4** | **触点引消理论 / 干预协议** | 扰动信号的布置、Kairos识别、弱测量、自测分流、承接与回流 | **操作协议层** |
| **L5** | **灯塔营销 (LMM)** | 面向公众的品牌表达与传播投射 | **传播层** |

```mermaid
graph TD
    L1["L1: 一元论主链<br/>DM → ASTO → TAT"]
    L2["L2: 应用认识论层<br/>哲学到领域的映射"]
    L3["L3: 市场诊断认识论（灯塔理论）<br/>系统诊断本体"]
...
- 在高争议、高客单或高风险场景中，`R=1` 应配套 `R-Eval` 客观校验
...
- 当说 `灯塔` 时，优先指问题显影层
- 当说 `自测` 时，优先指弱测量过滤层
- 当说 `港口承接` 时，优先指责任边界、确认单、首诊、报价与闭合入口
